...
@WebServlet("/Admindelete_company")
public class Admindelete_company extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Connection con=null;
	private PreparedStatement ps=null;
public Admindelete_company(){
	con=Dao.dbconnect();
}
 ...
 PreparedStatement ps=con.prepareStatement("delete company where username=?");
 ps.setString(1,name);
			               int qw=ps.executeUpdate();
			                 if(qw>0){
			        		     ...
			        		     RequestDispatcher rd=request.getRequestDispatcher("Admindelete_company.jsp");
