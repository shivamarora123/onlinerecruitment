...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Online Recuritment</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar mainmenu">
            <!-- use li tag and place all the values in sidebar -->
              
              <li class="active"><a href="#">Home</a></li>
			  <li><a href="#">Company Details</a></li>
             <li><a href="#">Examination Details</a>
                 <ul class="submenu">
                     <li><a href="#">Give Exam</a></li>
                     <li><a href="viewresultuser.jsp">View Result</a></li>
                 </ul></li>
